...
_Lưu ý: Bạn nên khởi chạy dịch vụ FastAPI Backend trước tại địa chỉ `http://localhost:8000` để ứng dụng có thể kết xuất danh sách thiết bị và bản ghi thành công._
