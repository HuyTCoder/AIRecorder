...
* **Nhập file âm thanh đa định dạng:** Hỗ trợ kéo thả hoặc chọn các tệp âm thanh từ bên ngoài như **MP3, M4A, WAV, OGG, FLAC, WEBM**... Hệ thống sử dụng Web Audio API để chuẩn hóa định dạng (resample về 16kHz, downmix sang Mono, convert sang 16-bit PCM WAV) ngay tại Frontend.
